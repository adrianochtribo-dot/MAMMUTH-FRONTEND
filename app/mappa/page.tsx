        ...
        <div className="mb-6">
          <Link
            ...
            style={{
              ...
              background: hover ? 'linear-gradient(135deg, #8B7CF6, #E879A0)' : 'rgba(255,255,255,0.55)',
              border: '1px solid rgba(139,124,246,0.45)',
              backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)',
              boxShadow: hover ? '0 8px 28px rgba(139,124,246,0.45)' : '0 2px 12px rgba(0,0,0,0.08)',
